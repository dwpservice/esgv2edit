       ...
       {props.details.map((sub,index) => (       
          ...
          <div key={sub.info} style={{margin: "8px",display:"flex",justifyContent:"left",flexDirection: "row",flexWrap:"nowrap",alignItems:"center"}}>                 
                        ...
                        <label  onClick={(event)=>{handleClick(event,index)}} 
                                style={sub.option === "o" 
                                ? {width: "500px",marginLeft: "10px",cursor: props.id === "8" ? "default":"pointer"}
                                :{color: "red",width: "500px",marginLeft: "10px",cursor: props.id === "8" ? "default":"pointer"}}  >
                            <Typography >
                            
                                <Badge  overlap='rectangular'
                                    badgeContent={parseInt(sub.score)}   
                                    color={sub.score === sub.maxscore ? "primary" : "error"}>
                                    {props.id === "8" ? sub.infoscreen : sub.info    }
                                </Badge>
                            </Typography>
                        </label>
                        {props.id !== "8" ? 
